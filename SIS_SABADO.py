...
class Student:
    ...
    def __init__ (self,root):
        ...
        MainFrame = Frame(self.root, bd=7, width=1300, height=750, relief=RIDGE, bg="maroon")
        MainFrame.grid()
        
        TopFrame1 = Frame(MainFrame,  width=1330, height=130, relief=RIDGE,bg="gold")
        TopFrame1.grid(row=2, column=0)
        
        TitleFrame = Frame(MainFrame, bg="Maroon",bd=5, width=1340, height=100, relief=RIDGE)
        TitleFrame.grid(row=0, column=0)
        
        TopFrame2 = Frame(MainFrame, bd=5,bg="Maroon", width=1340, height=450, relief=RIDGE)
        ...
        LeftFrame = Frame(TopFrame2, bd=5, width=1350, height=400, padx=2, bg="maroon", relief=RIDGE)
        LeftFrame.pack(side=LEFT)
        
        LeftFrame1 = Frame(LeftFrame, bd=5,bg="Gold", width=600, height=300, padx=2, pady=4, relief=RIDGE)
        LeftFrame1.pack(side=TOP, padx=0, pady=0)
        
        RightFrame1 = Frame(TopFrame2, bd=5, width=600, height=400, padx=2, bg="maroon", relief=RIDGE)
        ...
        self.lblTitle = Label(TitleFrame, font=('Quicksand',40,'bold'), text="MSU-IIT STUDENT MANAGEMENT SYSTEM", bg="Maroon",bd=7)
        self.lblTitle.grid(row=0, column=0, padx=135)
        
        #===========================================================================LABELS & ENTRy WIDGETS=======================================================#
        
        
        self.lblStudentID = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="STUDENT ID:",bg="gold", bd=5 , anchor=W)
        ...
        self.lblLastName = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="LAST NAME:",bg="gold",bd=7, anchor=W)
        ...
        self.lblFirstName = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="FIRST NAME:",bg="gold", bd=7, anchor=W)
        ...
        self.lblMiddleName = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="MIDDLE NAME:", bg="gold",bd=7, anchor=W)
        ...
        self.lblCourse = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="COURSE:",bg="gold", bd=7, anchor=W)
        ...
        self.lblGender = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="GENDER:", bg="gold",bd=7, anchor=W)
        ...
        self.lblYearLevel = Label(LeftFrame1, font=('Quicksand',12,'bold'), text="YEAR LEVEL:", bg="gold",bd=7, anchor=W)
